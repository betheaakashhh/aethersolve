          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2 text-slate-400">
                ...
                <a href="mailto:hello@aethersolve.com" className="hover:text-white transition-colors">
                  hello@aethersolve.com
                </a>
              </div>
              <div className="flex items-center gap-2 text-slate-400">
                <Phone size={13} className="text-brand-400 shrink-0" />
                <a href="tel:+918800000000" className="hover:text-white transition-colors">
                  +91 88000 00000
                </a>
              </div>
              <div className="flex items-center gap-2 text-slate-400">
            ...
            <div className="flex items-center gap-3 mt-5">
              {socials.map(({ icon: Icon, href, label }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-8 h-8 bg-slate-800 hover:bg-brand-600 rounded-lg flex items-center justify-center transition-colors group"
                >
