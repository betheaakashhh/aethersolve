      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            <div className="w-8 h-8 bg-gradient-to-br from-brand-600 to-teal-500 rounded-lg flex items-center justify-center shadow-md group-hover:shadow-brand-200 transition-shadow">
              <Zap size={16} className="text-white" fill="white" />
            </div>
            <div className="flex flex-col leading-none">
              <span className="font-display font-800 text-slate-900 text-base tracking-tight">AetherSolve</span>
        ...
        <div className="md:hidden bg-white border-t border-slate-100 shadow-lg animate-slide-down">
          <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-1">
            ...
            <div className="border-t border-slate-100 mt-2 pt-3 flex gap-2">
              <a href="#contact" className="flex-1 text-center py-2.5 text-sm font-semibold text-slate-600 border border-slate-200 rounded-xl" onClick={() => setOpen(false)}>Contact</a>
              <a href="#careers" className="flex-1 text-center py-2.5 text-sm font-semibold bg-brand-600 text-white rounded-xl" onClick={() => setOpen(false)}>Join Us</a>
            </div>
          </div>
        </div>
      )}
